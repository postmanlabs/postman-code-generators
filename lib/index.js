    ...
    validCodegen.forEach((codegen) => {
      ...
      try {
        if (typeof main.getOptions !== 'function') {
          throw TypeError('Codegen~getOptions: getOptions is not a function');
        }
        if (!main.getOptions) {
          throw ReferenceError('Codegen~convert: Could not find condegen corresponding to provided language, variant pair');
        }
      } catch(e) {
  ...
  convert (language, variant, request, options, callback) {
    ...
    try {
      if (!sdk.Request.isRequest(request)) {
        throw TypeError('Codegen~convert: Invalid request');
      } 
      ...
      languageMap.forEach((codegen) => {
        ...
        if (language.toLowerCase() === lang.toLowerCase() && variant.toLowerCase() === currentVariant.toLowerCase()) {
          ...
          if (typeof convert !== 'function') {
            throw TypeError('Codegen~convert: Convert is not a function');
          }
        }
      });
