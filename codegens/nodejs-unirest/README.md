...
## Using the Module
The module will expose an object which will have property `convert` which is the function for converting the Postman-SDK request to nodejs-unirest code snippet and `getOptions` function which returns an array of supported options.
