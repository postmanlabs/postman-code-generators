...
function extractFormData (dataArray, indentString, trimBody) {
  ...
  var snippetString = _.reduce(dataArray, (accumalator, item) => {
    ...
    if (item.type === 'file') {
      /**
             * creating snippet to send file in nodejs axios
             * for example:
             *  'fieldname': {
...
/**
 * parses header of request object and returns code snippet of nodejs axios to add header
 *
 * @param {Object} request - Postman SDK request object
 * @param {String} indentString - indentation required in code snippet
 * @returns {String} - code snippet of nodejs axios to add header
 */
