...
>Converts Postman-SDK Request into code snippet for JS Fetch
...
## Using the Module
The module will expose an object which will have property `convert` which is the function for converting the Postman-SDK request to js-fetch code snippet and `getOptions` function which returns an array of supported options.
