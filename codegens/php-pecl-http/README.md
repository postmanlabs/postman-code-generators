# codegen-php-pecl-http

>Converts Postman-SDK Request into code snippet for PHP-pecl-http
...
## Using the Module
The module will expose an object which will have property `convert` which is the function for converting the Postman-SDK request to php-pecl-http code snippet and `getOptions` function which returns an array of supported options.
